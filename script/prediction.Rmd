...
train %>% filter(appartment_name=='Poselenie Shherbinka 7.45217') %>%  select(id,price_persqm, price_doc, full_sq, full_sq2, product_type, year, appartment_name, appartment_price, n, everything()) %>% View()

test %>% filter(appartment_name=='Poselenie Shherbinka 7.45217') %>%  select(id, full_sq,  product_type, year, appartment_name, n, everything()) %>% View()
