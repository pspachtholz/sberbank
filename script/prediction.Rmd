...
arrange(train,desc(price_persqm)) %>% select(id,price_persqm, price_doc,price_doc2, full_sq, life_sq, life_sq2, kitch_sq, num_room, full_sq2, product_type, year, appartment_name, appartment_price, n, everything()) %>% View()
...
train %>% filter(str_detect(appartment_name,'Teplyj Stan')) %>% select(id,price_persqm, price_doc,price_doc2, full_sq, life_sq, kitch_sq,num_room,full_sq2, product_type, year, appartment_name, appartment_price, n, everything()) %>% View()
...
test %>% filter(appartment_name=='Horoshevo-Mnevniki 1.28305') %>%  select(id, full_sq, life_sq,life_sq2, kitch_sq,num_room, product_type, year, appartment_name, n, everything()) %>% View()
