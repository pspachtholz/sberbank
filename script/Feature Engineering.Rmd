...
basic_features <- c(outcome, "full_sq", "life_sq", "kitch_sq", "num_room", "floor", "max_floor", "material", "build_year", "state", "product_type")
...
newfeatures <- c("age_at_sale", "")

for (i in 1:10)
predictors <- c(setdiff(basic_features,outcome),"age_at_sale")
...
imp_matrix <- xgb.importance(colnames(train_sparse),xgb_model)
