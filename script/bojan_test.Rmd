...
train2 %>% ggplot(aes(x=full_sq, y=abs(pred-log(price_doc+1)))) + geom_point(stat="summary", size=2)+stat_smooth()

train2 %>% ggplot(aes(x=life_sq, y=abs(pred-log(price_doc+1)))) + geom_point(stat="summary", size=2)+stat_smooth()

train2 %>% ggplot(aes(x=floor, y=abs(pred-log(price_doc+1)))) + geom_point(stat="summary", size=2)+stat_smooth()

train2 %>% ggplot(aes(x=num_room, y=abs(pred-log(price_doc+1)))) + geom_point(stat="summary", size=2)+stat_smooth()
